        ...
        <div class="places" id="places">
            ...
            <div class="box-container">
                ...
                <?php foreach ($places as $place): ?>
                    <div class="box">
                        <img src="<?php echo $place['image']; ?>" alt="" class="img">
                        <div class="places_container">
                            <h3><i class="fas fa-map-marker-alt"></i><?php echo $place['emri']; ?></h3>
                            ...
                            <div class="price">$<?php echo $place['cmimi'] ?> <span>$120.00</span></div>
